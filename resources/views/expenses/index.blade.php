...
<script>
    function openModal(data, modal) {
        ...
        if (modal == 'delete') {
            document.getElementById('formDelete').action = "/expenses/" + data.id
        }
        ...
        if (modal == 'edit') {
            ...
            // Action
            document.getElementById('formUpdate').action = "/expenses/" + data.id
        }
    }
</script>
            ...
            <tr>
                ...
                <td>
                    ...
                    <button type="button" 
                        ...
                        onclick="openModal({{ json_encode($e) }}, 'edit')"
                        >
                    ...
                    <button type="button" 
                        ...
                        onclick="openModal({{ json_encode($e) }}, 'delete')"
                        >
...
<div class="modal fade" id="modalEdit" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body px-md-5">
                <h2 class="h4 text-center">Expenses </h2>
                    ...
                    <form action="" id="formUpdate" method="POST">
                      ...
                      <div class="row ">
                        <div class="col">
                          ...
                          <input type="taxtarea" class="form-control" placeholder="description" name="description" id="description">
