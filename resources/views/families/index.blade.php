...
<script>
    function openModal(data, modal) {
        ...
        if (modal == 'delete') {
            document.getElementById('formDelete').action = "/zones/" + data.id
        }
        ...
        if (modal == 'edit') {
            ...
            // Action
            document.getElementById('formUpdate').action = "/families/" + data.id
        }
    }
</script>
            ...
            <tr>
                ...
                <td>
                    ...
                    <button type="button" 
                        ...
                        onclick="openModal({{ json_encode($f) }}, 'edit')"
                        >
                    ...
                    <button type="button" 
                        ...
                        onclick="openModal({{ json_encode($f) }}, 'delete')"
                        >
                    ...
                    <form action="" id="formUpdate" method="POST">
                        ...
                        <div class="row">
                          <div class="col">
                            ...
                            <input type="text" class="form-control" placeholder="family name" name="name" id="name">
                          </div>
