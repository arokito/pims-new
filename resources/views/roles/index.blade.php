...
<script>
    function openModal(data, modal) {
        ...
        if (modal == 'delete') {
            document.getElementById('formDelete').action = "/roles/" + data.id
        }
        ...
        if (modal == 'edit') {
            ...
            // Action
            document.getElementById('formUpdate').action = "/roles/" + data.id
        }
    }
</script>
            ...
            <tr>
                ...
                <td>
                    ...
                    <button type="button" 
                        ...
                        onclick="openModal({{ json_encode($z) }}, 'edit')"
                        >
                    ...
                    <button type="button" 
                        ...
                        onclick="openModal({{ json_encode($z) }}, 'delete')"
                        >
...
<div class="modal fade" id="modalEdit" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body px-md-5">
                <h2 class="h4 text-center">Role </h2>
