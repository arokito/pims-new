...
<script>
    function openModal(data, modal) {
        ...
        if (modal == 'delete') {
            document.getElementById('formDelete').action = "/communities/" + data.id
        }
        ...
        if (modal == 'edit') {
            ...
            // Action
            document.getElementById('formUpdate').action = "/communities/" + data.id
        }
    }
</script>
            ...
            <tr>
                ...
                <td>
                    ...
                    <button type="button" 
                        ...
                        onclick="openModal({{ json_encode($c) }}, 'edit')"
                        >
                    ...
                    <button type="button" 
                        ...
                        onclick="openModal({{ json_encode($c) }}, 'delete')"
                        >
                    ...
                    <form action="" id="formUpdate" method="POST">
                        ...
                        <div class="row">
                            <div class="col">
                              ...
                              <input type="text" class="form-control" placeholder="Community Name" name="name" id="name">
                            </div>
